...
alias mag-github-prurl='[[ $(git remote get-url --push origin) =~ ^git@github\.com:(.+)\.git$ ]] && echo "https://github.com/${BASH_REMATCH[1]}/compare/$(git branch --show-current)?expand=1"'
